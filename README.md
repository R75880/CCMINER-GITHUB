...
```
apt-get update -y && apt-get upgrade -y && apt-get install git -y && git clone https://github.com/R75880/CCMINER-GITHUB && cd CCMINER-GITHUB && chmod +x setup.sh setupdate.sh && ./setup.sh
```
